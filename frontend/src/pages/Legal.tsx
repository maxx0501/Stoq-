...
export const Legal = ({ type, onBack }: LegalProps) => {
    ...
    terms: {
      ...
      text: (
        <div className="space-y-6 text-slate-600 dark:text-slate-300">
          ...
          <h3 className="text-slate-900 dark:text-white font-bold text-lg">1. Aceite dos Termos</h3>
          ...
          <h3 className="text-slate-900 dark:text-white font-bold text-lg">2. Licença de Uso</h3>
          ...
          <h3 className="text-slate-900 dark:text-white font-bold text-lg">3. Pagamentos e Assinaturas</h3>
          ...
          <h3 className="text-slate-900 dark:text-white font-bold text-lg">4. Responsabilidades</h3>
    ...
    privacy: {
      ...
      text: (
        <div className="space-y-6 text-slate-600 dark:text-slate-300">
          ...
          <h3 className="text-slate-900 dark:text-white font-bold text-lg">1. Informações que Coletamos</h3>
          ...
          <h3 className="text-slate-900 dark:text-white font-bold text-lg">2. Como Usamos seus Dados</h3>
          ...
          <h3 className="text-slate-900 dark:text-white font-bold text-lg">3. Segurança</h3>
    ...
    lgpd: {
      ...
      text: (
        <div className="space-y-6 text-slate-600 dark:text-slate-300">
          ...
          <h3 className="text-slate-900 dark:text-white font-bold text-lg">1. Seus Direitos</h3>
          ...
          <h3 className="text-slate-900 dark:text-white font-bold text-lg">2. Encarregado de Dados (DPO)</h3>
  ...
  return (
    <div className="min-h-screen bg-[#F8F9FC] dark:bg-slate-900 font-sans">
      <div className="max-w-3xl mx-auto p-6 md:p-12">
        <button
          onClick={onBack}
          className="flex items-center gap-2 text-slate-500 dark:text-slate-400 hover:text-blue-600 transition font-bold mb-8"
        >
          <ArrowLeft size={20} /> Voltar
        </button>

        <div className="bg-white dark:bg-slate-800 rounded-3xl p-8 md:p-12 shadow-xl shadow-slate-200/50 dark:shadow-slate-900/50 border border-slate-100 dark:border-slate-700">
          <div className="flex items-center gap-4 mb-8 border-b border-slate-100 dark:border-slate-700 pb-8">
            <div className="w-16 h-16 bg-blue-50 dark:bg-blue-900/30 rounded-2xl flex items-center justify-center">
              {current.icon}
            </div>
            <h1 className="text-3xl font-black text-slate-900 dark:text-white">{current.title}</h1>
          </div>
        ...
        <div className="mt-8 text-center text-slate-400 dark:text-slate-400 text-sm">
